...
/datum/preference/numeric/voice_pitch/is_accessible(datum/preferences/preferences)
	if(!..(preferences))
		return
	return (preferences.read_preference(/datum/preference/choiced/vocals/voice_type) == VOICE_TYPE_BARK)
...
/datum/preference/choiced/vocals/voice_type/init_possible_values()
	return list(VOICE_TYPE_BARK, VOICE_TYPE_NONE)
...
/datum/preference/choiced/vocals/blooper/is_accessible(datum/preferences/preferences)
	...
	return (voice_type_pref == VOICE_TYPE_BARK)

/datum/preference/choiced/vocals/blooper/init_possible_values()
	return assoc_to_keys(GLOB.blooper_list)

/datum/preference/choiced/vocals/blooper/apply_to_human(mob/living/carbon/human/target, value)
