...
export function Orbit(props) {
  ...
  const [realNameDisplay, setRealNameDisplay] = useState(true); // DARKPACK EDIT, ORIGINAL: const [realNameDisplay, setRealNameDisplay] = useState(false);  const [searchQuery, setSearchQuery] = useState('');
