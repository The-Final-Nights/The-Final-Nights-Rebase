...
#define CHANNEL_AMBIENCE_STEMS 1009 // TFN EDIT ADD - ambience layer for stems/accents
#define CHANNEL_AMBIENCE_POSITIONAL 1008 // TFN EDIT ADD - positional one-shot ambience (nature, city)
//THIS SHOULD ALWAYS BE THE LOWEST ONE!
//KEEP IT UPDATED
#define CHANNEL_HIGHEST_AVAILABLE 1007 // TFN EDIT
