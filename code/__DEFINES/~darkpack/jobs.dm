...
#define JOB_DISPLAY_ORDER_JAZZ 18 //TFN EDIT ADDITION START - Crown Blues Jazz Club Rework
...
#define JOB_DISPLAY_ORDER_REEVE 27 // TFN EDIT CHANGE - Adds Reeve - Original: #define JOB_DISPLAY_ORDER_SWEEPER 28
#define JOB_DISPLAY_ORDER_SWEEPER 28 //TFN CHANGE - Adds Reeve - Original: #define JOB_DISPLAY_ORDER_BRUISER 29
#define JOB_DISPLAY_ORDER_BRUISER 29 //TFN CHANGE - Adds Reeve - Original: #define JOB_DISPLAY_ORDER_LIAISON 30 - Liason is not being used right now on TFN
...
#define JOB_DISPLAY_ORDER_REDNEWS 64 //TFN EDIT ADDITION START - Red News
