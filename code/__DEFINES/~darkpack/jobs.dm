...
#define JOB_FIGHT_CLUB_WORKER "Fight Club Worker" //TFN EDIT ADDITION START - Body Shop Fight Club
...
#define JOB_DISPLAY_ORDER_FIGHT 20 //TFN EDIT ADDITION START - Body Shop Fight Club
#define JOB_DISPLAY_ORDER_TAXI 21
#define JOB_DISPLAY_ORDER_PRIEST 22

//TFN EDIT ADDITION START - Setite Faction
#define JOB_DISPLAY_ORDER_HIGH_PRIEST 23
#define JOB_DISPLAY_ORDER_FAITHFUL 24
#define JOB_DISPLAY_ORDER_WARD 25
#define JOB_DISPLAY_ORDER_ASSOCIATE 26

#define JOB_DISPLAY_ORDER_BARON 27
#define JOB_DISPLAY_ORDER_EMISSARY 28
#define JOB_DISPLAY_ORDER_REEVE 29 // TFN EDIT CHANGE - Adds Reeve - Original: #define JOB_DISPLAY_ORDER_SWEEPER 28
#define JOB_DISPLAY_ORDER_SWEEPER 30 //TFN CHANGE - Adds Reeve - Original: #define JOB_DISPLAY_ORDER_BRUISER 29
#define JOB_DISPLAY_ORDER_BRUISER 31 //TFN CHANGE - Adds Reeve - Original: #define JOB_DISPLAY_ORDER_LIAISON 30 - Liason is not being used right now on TFN
...
#define JOB_DISPLAY_ORDER_KEEPER 50 // TFN EDIT CHANGE - Wyrmfoe - Original: #define JOB_DISPLAY_ORDER_WYRMFOE 48
...
#define JOB_DISPLAY_ORDER_SABBAT_BISHOP 58
#define JOB_DISPLAY_ORDER_SABBAT_PALADIN 59
#define JOB_DISPLAY_ORDER_TRUE_SABBAT 60
#define JOB_DISPLAY_ORDER_REVENANT 61

#define JOB_DISPLAY_ORDER_ABBE 62 // TFN EDIT CHANGE - Original: #define JOB_DISPLAY_ORDER_ABBE 54
#define JOB_DISPLAY_ORDER_INQUISITOR 63 // TFN EDIT CHANGE - Original: #define JOB_DISPLAY_ORDER_INQUISITOR 55
#define JOB_DISPLAY_ORDER_CONDOTTIERI 64 // TFN EDIT CHANGE - Original: #define JOB_DISPLAY_ORDER_CONDOTTIERI 56
#define JOB_DISPLAY_ORDER_NOVICE 65 // TFN EDIT CHANGE - Original: #define JOB_DISPLAY_ORDER_NOVICE 57
...
//TFN EDIT ADD - Body Shop Fight Club
#define DEPARTMENT_BITFLAG_FIGHT_CLUB (1<<19)
#define DEPARTMENT_FIGHT_CLUB "Fight_Club"
// TFN EDIT ADD END - Fight Club Jobs
...
DEFINE_BITFIELD(departments_bitflags, list(
	...
	"FIGHT_CLUB" = DEPARTMENT_BITFLAG_FIGHT_CLUB, //TFN EDIT ADDITION START - Body Shop Fight Club
...
#define EXP_TYPE_FIGHT_CLUB "Fight Club" //TFN EDIT ADDITION START - Body Shop Fight Club
