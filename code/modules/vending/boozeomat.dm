	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/reagent_containers/cup/glass/drinkingglass/shot_glass = 12, // DARKPACK EDIT START
				/obj/item/reagent_containers/cup/glass/drinkingglass/wine_glass = 15, // DARKPACK EDIT ADD END
