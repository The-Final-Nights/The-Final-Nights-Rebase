...
/mob/dead/new_player
	...
	density = FALSE
	stat = DEAD
	// hud_type = /datum/hud/new_player // TFN EDIT REMOVAL - lobby screen 2.0
...
/mob/dead/new_player/proc/make_me_an_observer()
	...
	var/this_is_like_playing_right = tgui_alert(usr, "Are you sure you wish to observe? You will not be able to play this round![less_input_message]", "Observe", list("Yes", "No")) // TFN EDIT - converting to TGUI because there is zero reason why it shouldn't be, weird commenter from the past
	if(QDELETED(src) || !src.client || this_is_like_playing_right != "Yes")
		ready = PLAYER_NOT_READY
		//show_title_screen() // TFN EDIT ADD - lobby screen 2.0
		return FALSE

	hide_title_screen() // TFN EDIT ADD - lobby screen 2.0
