...
/obj/structure/retail/black_market
	products_list = list(
		...
		new /datum/data/vending_product("knife",	/obj/item/melee/vampirearms/knife,	85),
		new /datum/data/vending_product("switchblade",	/obj/item/melee/vampirearms/knife/switchblade, 85),
