...
/obj/structure/retail/black_market
	products_list = list(
		...
		//new	/datum/data/vending_product("meth package", /obj/item/reagent_containers/cup/glass/meth,	800),
		//new	/datum/data/vending_product("cocaine package", /obj/item/reagent_containers/cup/glass/meth/cocaine,	800),
