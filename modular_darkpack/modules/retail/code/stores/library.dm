/obj/structure/retail/library
	products_list = list(
		...
		new /datum/data/vending_product("canvas (24x24)", /obj/item/canvas/twentyfour_twentyfour, 24),
		new /datum/data/vending_product("canvas (36x24)", /obj/item/canvas/thirtysix_twentyfour, 36),
