/obj/structure/retail/grocery_store
	...
	products_list = list(
		...
		new /datum/data/vending_product("raisins", /obj/item/food/no_raisin, 3),
		...
		new /datum/data/vending_product("soybeans", /obj/item/food/grown/soybeans), // TFN EDIT - COOKING UPDATE
		new /datum/data/vending_product("peanut", /obj/item/food/grown/peanut), // TFN EDIT - COOKING UPDATE
		new /datum/data/vending_product("cucumber", /obj/item/food/grown/cucumber), // TFN EDIT - COOKING UPDATE
	...
	// TFN EDIT - COOKING UPDATE END
		...
		new /datum/data/vending_product("egg carton", /obj/item/storage/fancy/egg_box, 6),
