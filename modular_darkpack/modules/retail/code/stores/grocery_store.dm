/obj/structure/retail/grocery_store
	...
	products_list = list(
		...
		new /datum/data/vending_product("beer bottle", /obj/item/reagent_containers/cup/glass/beer/vampire),
		new /datum/data/vending_product("blue stripe", /obj/item/reagent_containers/cup/glass/beer/vampire/blue_stripe),
