...
/obj/item/reagent_containers/cup/baggie/meth
	name = "blue package"
	icon_state = "package_meth"
	list_reagents = list(/datum/reagent/drug/methamphetamine = 30)

/*
/obj/item/reagent_containers/cup/baggie/meth/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/selling, 300, "meth", TRUE, -1, 4)
*/

/obj/item/reagent_containers/cup/baggie/meth/cocaine
	name = "white package"
	icon_state = "package_cocaine"
	list_reagents = list(/datum/reagent/drug/methamphetamine/cocaine = 30)

/*
/obj/item/reagent_containers/cup/baggie/meth/cocaine/Initialize(mapload)
	. = ..()
