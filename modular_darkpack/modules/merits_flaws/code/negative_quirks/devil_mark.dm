/datum/quirk/darkpack/devil_mark
	...
	included_clans = list(VAMPIRE_CLAN_BAALI)
	icon = FA_ICON_STAR
...
/datum/quirk/darkpack/devil_mark/add_to_holder(mob/living/new_holder, quirk_transfer, client/client_source, unique, announce)
	...
	if(ishuman(new_holder))
		...
		owner_splat.clan.accessories = list("baali_full", "baali_left", "baali_right", "baali_broken", "baali_round", "baali_oni", "baali_devil", "baali_legs_and_tail", "baali_claws", "none")
