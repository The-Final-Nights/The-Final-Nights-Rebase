...
/datum/outfit/job/bruiser
	...
	backpack_contents = list(/obj/item/passport=1, /obj/item/cockclock=1, /obj/item/vampire_stake=3, /obj/item/flashlight=1, /obj/item/vamp/lockpick=1, /obj/item/card/credit=1)
