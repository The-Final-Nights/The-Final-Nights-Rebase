/datum/outfit/job/sabbatist
	...
	backpack_contents = list(/obj/item/passport=1, /obj/item/vampire_stake=3, /obj/item/gun/ballistic/vampire/revolver=1, /obj/item/melee/vamp/knife=1, /obj/item/vamp/keys/hack=1, /obj/item/katana/vamp/kosa=1)
