...
/datum/outfit/job/vdoctor
	...
	backpack_contents = list(/obj/item/passport=1, /obj/item/cockclock=1, /obj/item/flashlight=1, /obj/item/card/credit=1, /obj/item/storage/darkpack/firstaid/doctor=1)
