...
//	gloves = /obj/item/clothing/gloves/color/black
	...
	r_hand = /obj/item/melee/vamp/shovel
	backpack_contents = list(/obj/item/passport=1, /obj/item/cockclock=1, /obj/item/flashlight=1, /obj/item/vamp/creditcard=1, /obj/item/katana/vamp/kosa=1)
