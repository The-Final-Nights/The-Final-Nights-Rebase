...
/datum/outfit/job/bogatyr
	...
	backpack_contents = list(/obj/item/vamp/keys/old_clan_tzimisce=1, /obj/item/fireaxe/vamp=1, /obj/item/passport=1, /obj/item/flashlight=1, /obj/item/vamp/creditcard=1)
