...
/datum/splat/werewolf/kinfolk/get_splat_lore()
	return list(
		"Despite being far better able to interact with their breed (species) than Garou of the same breed, neither human nor animal kinfolk belong purely to their respective species. Human kinfolk generally had a bit more spirituality and connection to nature, being slightly of the wolf, than did the masses of humanity. Animal kinfolk had more cognizance than their non-Kin fellows and thus had a bit of human in them, separating them from other wolves to a degree.\n\nKinfolk are related by varying degrees to the Garou by blood, but do not possess the spiritual component necessary to undergo the First Change. They are divided into two breeds, human or wolf (or appropriate animal species for kinfolk of Fera), which are not to be confused with the homid or lupus breeds that are specific to Gaias chosen. No kinfolk possess Rage, nor are they blessed by Luna or Helios with an Auspice.\n\nThis lack of favor also means that theyre immune to the effects that silver (or gold for some fera) has on their true breed kin. Gaia does favor kinfolk above normal humans (and animals), thus a very small minority of kinfolk who arent also Awakened beings may possess small degrees of Gnosis. A very rare kin learned rudimentary Gifts. The Children of Gaia are exceptional to the rest of the tribes for their general endorsement of their kinfolk learning healing and social gifts."
	)
...
/datum/splat/werewolf/shifter/garou/get_splat_lore()
	return list(
		"Garou have a robust mythology regarding their existence and connection to nature and the earth, following the creation myth and metaphysics of the Triat, the three primary Gods of their mythology.\n\nThe Triat consists of the Wyld, Weaver, and Wyrm, representing creation, order, and destruction, respectively.\n\nThe oral tradition of the Garou holds that the Triat were once in balance, creating harmony in reality, but recently have fallen into disharmony in the modern age of pollution, mass industrialization, and rampant exploitation of the natural resources of Gaia. The Wyld, representing Order, is stronger than it's ever been due to the rise of humanity and modern civilization, and consequently, the destructive capacity of the Wyrm also grows as the Earth is plundered, and the Wyld's influence retreats, throwing the Triat into disorder.\n\nMany tribes of the Garou have different perspectives on this oral history and what must be done to prevent the Apocalypse - the day when the Wyrm, the destructive force of the Triat, overpoweres the Weaver and is allowed to destroy and consume unchecked.",
	)
