...
/datum/discipline_power/obtenebration/arms_of_the_abyss/activate()
	...
	owner.put_in_r_hand(new /obj/item/melee/vamp/knife/gangrel/lasombra(owner))
	owner.put_in_l_hand(new /obj/item/melee/vamp/knife/gangrel/lasombra(owner))

/datum/discipline_power/obtenebration/arms_of_the_abyss/deactivate()
	. = ..()
	for(var/obj/item/melee/vamp/knife/gangrel/lasombra/arm in owner.contents)
		qdel(arm)
