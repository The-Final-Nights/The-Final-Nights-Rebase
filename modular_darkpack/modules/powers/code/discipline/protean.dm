...
/datum/discipline_power/protean/eyes_of_the_beast/activate()
	...
	owner.put_in_r_hand(new /obj/item/melee/vamp/knife/gangrel(owner))
	owner.put_in_l_hand(new /obj/item/melee/vamp/knife/gangrel(owner))
	owner.add_client_colour(/datum/client_colour/glass_colour/red)

/datum/discipline_power/protean/eyes_of_the_beast/deactivate()
	. = ..()
	for(var/obj/item/melee/vamp/knife/gangrel/G in owner.contents)
		qdel(G)
