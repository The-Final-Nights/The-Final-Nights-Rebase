...
/obj/item/smartphone/supply_tech/associate //TFN ADDITION START - Setite Faction
	contact_networks_pre_init = list(
...
/obj/item/smartphone/dealer/high_priest //TFN ADDITION START - Setite Faction
	important_contact_of = VAMPIRE_CLAN_SETITE //TFN ADDITION END - Setite Faction
