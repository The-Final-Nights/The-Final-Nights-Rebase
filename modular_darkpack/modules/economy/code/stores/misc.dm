/obj/machinery/mineral/equipment_vendor/fastfood/illegal	// PSEUDO_M make this restricted and only available for triads
	prize_list = list(
		...
		new	/datum/data/mining_equipment("meth package",	/obj/item/reagent_containers/cup/baggie/meth,	800),
		new	/datum/data/mining_equipment("cocaine package",	/obj/item/reagent_containers/cup/baggie/meth/cocaine,	800),
