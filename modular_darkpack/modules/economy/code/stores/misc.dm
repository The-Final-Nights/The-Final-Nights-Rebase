/obj/machinery/mineral/equipment_vendor/fastfood/illegal	// PSEUDO_M make this restricted and only available for triads
	prize_list = list(
		...
		new /datum/data/mining_equipment("knife",	/obj/item/melee/vamp/knife,	85),
		new /datum/data/mining_equipment("switchblade",	/obj/item/melee/vamp/knife/switchblade, 85),
