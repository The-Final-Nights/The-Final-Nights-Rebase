/obj/machinery/fax
	special_networks = list(
		...
		camarillaadmin = list(fax_name = "Prince", fax_id = "camarillaadmin", color = "teal", emag_needed = TRUE),
		...
		tremereadmin = list(fax_name = "Tremere Council", fax_id = "tremereadmin", color = "green", emag_needed = FALSE),
	)
...
/obj/machinery/fax/camarilla
	...
	fax_id = "camarilla"
	special_networks = list(camarillaadmin = list(fax_name = "Prince", fax_id = "camarillaadmin", color = "teal", emag_needed = FALSE))
...
/obj/machinery/fax/tremere
	fax_name = "Library"
	fax_id = "library"
	special_networks = list(tremereadmin = list(fax_name = "Tremere Council", fax_id = "tremereadmin", color = "green", emag_needed = FALSE))
